...
{
    public record CandidateModels : BaseEntityModel
    {
        ...
        public string[] DepartmentIdsArray { get; set; }
    ...
    public record CandidateSearchModel : BaseSearchModel
    {
        ...
        public string MobileNumber { get; set; }
        public string StatusId { get; set; }
        public List<string> AppliedWorkLocationId { get; set; }
        public DateTime? JobApplyDate { get; set; }
        public List<string> AppliedJobPosition { get; set; }
        public DateTime? FromDate { get; set; }
        public DateTime? ToDate { get; set; }
        public string SearchText { get; set; }
    }

    public record CandidateListModel : BasePagedListModel<CandidateModels>
    {
