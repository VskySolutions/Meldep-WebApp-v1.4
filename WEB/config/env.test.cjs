module.exports = {
  // API_BASE_URL: "https://meldepv3-2api.vskyapplications.com",
  API_BASE_URL: "https://dev4-0api.meldep.com",
  BUILD_PUBLIC_PATH: "",
  PUBLISH_FOLDER: "",
  IGNORE_PUBLIC_FOLDER: false,
  BASE_COUNTRY_ID: "6C541A72-E1AC-4A84-9611-6A2655ADE639",
  BASE_REPORTING_URL: "https://meldepv3-2-dev-reporting.vskyapplications.com", // Reporting URL
  MS_Login_BASE_URL: "https://dev4-0.meldep.com/auth/login",
  MS_Logout_BASE_URL: "https://dev4-0.meldep.com/auth/login",
  ...
  AI_Chat_Assistant_Instance: "dev"
};
