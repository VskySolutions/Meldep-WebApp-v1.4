      ...
      <div class="q-pa-md cardTable">
        <div class="q-gutter-y-md">
          <q-tabs v-model="tab" dense class="text-primary" active-color="primary" indicator-color="primary" active-class="bg-blue-1 borderRadiusTabs" align="left" narrow-indicator>
            ...
            <q-tab name="2_tab" label="Project Info." class="q-px-lg q-mr-md" />
            <q-tab name="3_tab" label="Project Charter" class="q-px-lg" />
            <q-tab v-if="role === 'admin'" name="4_tab" label="Infra Services" class="q-px-lg" :disable="disableTab" />
          </q-tabs>
          <q-separator />
