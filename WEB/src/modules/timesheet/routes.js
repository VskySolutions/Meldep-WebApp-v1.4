export default [
  {
    ...
    children: [
      ...
      { path: "/weekly-timesheet-approval", name: "weekly-timesheet-approval", component: () => import("modules/timesheet/pages/weeklyTimesheetApproval.vue"), meta: { requiresAuth: true, title: "Weekly Timesheet Approval" } }
    ]
  }
];
