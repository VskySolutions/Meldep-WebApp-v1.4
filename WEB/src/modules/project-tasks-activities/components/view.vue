<template>
  <q-dialog ref="dialogRef" class="customDialog" persistent position="right" @hide="onDialogHide">
    <q-card class="q-dialog-plugin PersonMain card-header with-tools headerBasic" style="width: 1000px; max-width: 100vw; height: 100% !important;">
      ...
      <div class="q-pa-md cardTable">
        <div class="q-gutter-y-md">
          <fieldset>
            ...
            <div class="row q-col-gutter-x-md q-mb-md">
              <div class="col-12 col-sm-12 col-md-12">
                ...
                <div class="text-black">
                  {{ model.task.name ? model.task.name : "-" }}
                </div>
              </div>
            </div>
            <div class="row q-col-gutter-x-md q-mb-md">
              <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="text-black">
                  ...
                  <q-icon
                    v-if="model.activityNameDescription"
                    name="o_info"
                    size="17px"
                    class="q-ml-xs"
                  >
                    <q-tooltip v-if="model.activityNameDescription" class="text-wrap break-words q-pa-sm" max-width="300px">
                      <div v-html="model.activityNameDescription" />
                    </q-tooltip>
                  </q-icon>
                </div>
              </div>
            ...
            <div class="row q-col-gutter-x-md q-mb-md">
              <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="text-black">
                  {{ model.createdByUser.person.fullName ? model.createdByUser.person.fullName : "-" }}
                </div>
              </div>
              <div class="col-12 col-sm-6 col-md-6">
            ...
            <div class="row q-col-gutter-x-md q-mb-md">
              <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="text-black">
                  {{ model.updatedByUser.person.fullName ? model.updatedByUser.person.fullName : "-" }}
                </div>
              </div>
              <div class="col-12 col-sm-6 col-md-6">
          ...
          <fieldset class="q-mb-lg hidden">
            <legend>Project Task Activity Files</legend>
            <q-table
...
// get project details
const getProjectTaskActivityDetails = () => {
  loading.value = true;
  projectActivitiesService.getProjectActivity(props.id).then((resp) => {
    model.value = _.cloneDeep(resp);
    filesrows.value = resp.projectTaskActivityFilesList.map(item => ({
      ...item
    }));
  }).finally(() => {
    loading.value = false;
