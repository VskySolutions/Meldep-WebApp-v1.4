...
import requirementCenterRoutes from "modules/requirement-center/routes";
...
import infraDashboardRoutes from "modules/infra-dashboard/routes";
...
routes.push(...requirementCenterRoutes);
...
routes.push(...infraDashboardRoutes);
